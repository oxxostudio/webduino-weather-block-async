Blockly.Blocks['get_weather'] = {
  init: function () {
    ...
    this.setTooltip("");
    this.setHelpUrl("");
    this.setCommentText("取得氣象資料之後，才會繼續執行下方程式");
  }
};

Blockly.Blocks['get_weather_aqi'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("空氣品質，地點")
      .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks['get_weather_observe'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("即時觀測，地點")
      .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks['get_weather_forecast'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("氣象預報，地點")
      .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks['get_weather_reservoir'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("水庫水情，地點")
      .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks['get_weather_quake'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("地震資訊，最近")
      .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks['get_weather_radar'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("雷達回波圖");
    this.setOutput(true, null);
